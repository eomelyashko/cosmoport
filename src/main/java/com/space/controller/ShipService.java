...
public class ShipService {
    ...
    List<Ship> getShipsList(
        ...
        @RequestParam(name = "minRating", required = false)Double minRaiting,
        @RequestParam(name = "maxRating", required = false)Double maxRaiting,
        @RequestParam(name = "order", required = false, defaultValue = "ID")ShipOrder order,
        @RequestParam(name = "pageNumber", required = false, defaultValue = "0")Integer pageNumber,
        @RequestParam(name = "pageSize", required = false, defaultValue = "3")Integer pageSize,
        Model model
    ) {
        List<Ship> ships = getListWithFilters(name, planet, shipType, after, before, isUsed, minSpeed, maxSpeed, minCrewSize, maxCrewSize, minRaiting, maxRaiting);
    ...
    @RequestMapping(value = "/ships/count", method = RequestMethod.GET)public @ResponseBody
    int getCount(
            @RequestParam(name = "name", required = false)String name,
            @RequestParam(name = "planet", required = false)String planet,
            @RequestParam(name = "shipType", required = false) ShipType shipType,
    ...
    public @ResponseBody
    ResponseEntity<Ship> createShip(@RequestBody Map<String, String> args) {
